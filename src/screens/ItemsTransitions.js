...
const ItemsTransitions = ({ socket, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <PostLists navigation={navigation} initial={`itemsTransitions`} />
      {loading ? (
...
export default ItemsTransitions;
