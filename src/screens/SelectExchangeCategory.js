...
const SelectExchangeCategory = ({ navigation, socket }) => {
  ...
  const data = [
    {
      value: 1,
      nav: `Equipment`,
      label: lang === "ar" ? Ar.Equipment : En.Equipment,
      desc: lang === "ar" ? Ar.EquipmentDesc : En.EquipmentDesc,
    },
    {
      value: 2,
      nav: `Workshop`,
      label: lang === "ar" ? Ar.WorkShop : En.WorkShop,
      desc: lang === "ar" ? Ar.WorkShopDesc : En.WorkShopDesc,
    },
  ];
  ...
  const handleProceed = () => {
    ...
    navigation.navigate("Exchange", { category: desired["nav"] });
  };
...
export default SelectExchangeCategory;
